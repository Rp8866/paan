...
<body>
  ...
  <header id="header" class="fixed-top ">
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <h1 class="logo"><a href="index.html">ForEver Agancy</a></h1>
  ...
  <section id="hero">
    <div class="hero-container" data-aos="fade-up" data-aos-delay="150">
      ...
      <div class="d-flex">
        <a  href=" {{url ('/new')}} " target="_blank"  class="btn-get-started scrollto">New</a> &nbsp;
        <a href="{{url ('/update')}} " target="_blank" class="btn-get-started scrollto">Update</a>
